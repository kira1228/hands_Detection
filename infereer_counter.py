            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img:
                        ...
                        n_1 = (det[:, -1] == 0).sum()  # count the total num of riceball
                        a = f"{n_1} " 
                        cv2.putText(img_ori, "Okazu counter " , (20, 50), 0, 1.0, (71, 99, 255), 3)
                        cv2.putText(img_ori, "riceball : " + str(a), (20, 100), 0, 1.5, (71, 99, 255), 3)
                        n_2 = (det[:, -1] == 1).sum() # count the total num of wiener
                        b = f"{n_2} "
                        cv2.putText(img_ori, "wiener : " + str(b), (20, 150), 0, 1.5, (0, 215, 255), 3)
                        n_3 = (det[:, -1] == 2).sum() # count the total num of karaage
                        d = f"{n_3} "
                        cv2.putText(img_ori, "karaage : " + str(d), (20, 200), 0, 1.5, (154, 250, 0), 3)
                        n_4 = (det[:, -1] == 3).sum() # count the total num of tamagoyaki
                        e = f"{n_4} "
                        cv2.putText(img_ori, "tamagoyaki : " + str(e), (20, 200), 0, 1.5, (154, 250, 0), 3)                         
